...
Please use {Thinking Sphinx}[http://freelancing-god.github.com/ts/en/] instead.

You should probably do that, but I'm maintaining this minorly patched version to keep our app running with ultrasphinx until we finish making the transition to whatever we decide to use instead.
